...
MIDDLEWARE = [
    ...
    "apps.user_management.presentation.middleware.JWTAuthenticationMiddleware",
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "therapy_center"),
        "USER": os.getenv("DB_USER", "therapy_user"),
        "PASSWORD": os.getenv("DB_PASSWORD", "therapy_pass"),
